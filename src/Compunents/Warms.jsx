...
const Warms = () => {
  return (
    <div>
      ...
      <div className="text-center grid md:grid-cols-4 gap-10">
        <div className=" h-[200px] w-[270px] bg-white hover:shadow-2xl rounded-3xl p-5 transition  animate__animated animate__fadeInUp animate__delay-2s">
        ...
        <div className=" h-[200px] w-[270px] bg-white hover:shadow-2xl rounded-3xl p-5 animate__animated animate__fadeInUp animate__delay-2s">
